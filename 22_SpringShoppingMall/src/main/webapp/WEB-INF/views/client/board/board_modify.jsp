...
$(function(){
   ...
   $("#board_content").summernote('code', '${board_content_bean.board_content_text}')
})
...
// 입력 요소들 유효성검사
   function check_input(){
      ...
      var board_category_idx = ${board_category_idx}
      ...
      var params = {
            ...
            board_category_idx : ${board_category_idx},
				...
				<div class='card'>
					<div class='card-body'>
						<form onsubmit=' return check_input()'>
							...
							<input type='hidden' id='board_category_idx'
								value='${board_category_idx}'>

							<div class='form-group'>
								<label for='board_content_subject'>제목</label> <input type='text'
									id='board_content_subject' class='form-control'
									value='${board_content_bean.board_content_subject }' />
							</div>
							<div class='form-group'>
							...
							<div class='form-group text-right'>
								...
								<a href='board_main.springshoppingmall?page_num=${page_num}&board_category_idx=${board_category_idx}' class='btn btn-primary'>취소</a>
							</div>
						</form>
