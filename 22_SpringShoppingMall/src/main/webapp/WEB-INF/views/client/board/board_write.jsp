	...
	function check_input(){
		...
		$.ajax({
			...
			success : function(result){
				if(result.result == 'OK'){
					alert('작성이 완료되었습니다');
					location.href = "board_read.springshoppingmall?page_num=" + result.page_num +"&board_category_idx=" + result.board_category_idx + "&board_content_idx=" + result.board_content_idx
				}
			}
		})
		return false
