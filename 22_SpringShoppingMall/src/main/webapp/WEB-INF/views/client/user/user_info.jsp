...
<div class='container' style='margin-top:100px;min-height:500px'>
	<div class='row'>
		...
		<div class='col-md-6'>
			...
			<div class='card'>
				<div class='card-body'>
					<form action='user_info.jica' method='post' onsubmit='return check_input()'>
						<div class='form-group'>
							<label for='user_name'>이름</label>
							<input type='text' id='user_name' class='form-control' value='홍길동' readonly="readonly"/>
						</div>
						<div class='form-group'>
							<label for='user_id'>아이디</label>
							<input type='text' id='user_id' class='form-control' value='abcd' readonly="readonly"/>
						</div>
						<div class='form-group'>
						...
						<div class='form-group'>
							...
							<div class='input-group'>
								<input type='text' id='sample2_postcode' class='form-control' readonly="readonly" value='11111'/>
						...
						<div class='form-group'>
							<input type='text' id='sample2_address' class='form-control' readonly="readonly" value='주소1'/>
						</div>
						<div class='form-group'>
							<input type='text' id='sample2_detailAddress' class='form-control' value='주소2'/>
						</div>
						<div class='form-group'>
						...
						<div class='form-group'>
							...
							<div class='row'>
								...
								<div class='col-md-4'>
									<input type='text' id='user_phone2' value='1111' class='form-control' maxlength='4'/>
								</div>
								<div class='col-md-4'>
									<input type='text' id='user_phone3' value='2222' class='form-control' maxlength='4'/>
								</div>
							</div>
						</div>
